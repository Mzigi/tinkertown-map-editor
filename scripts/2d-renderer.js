...
let canvasElement = document.getElementById("2Dcanvas")
...
function drawChunkCache(chunk) {
    let cacheCanvasElement = document.createElement("canvas")
    cacheCanvasElement.style = "width:224px; height:224px; image-rendering: pixelated;"
