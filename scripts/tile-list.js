        ...
        for (let i in resultItems) {
            ...
            if (itemInfo) {
                ...
                slot.addEventListener("click", () => {
                    ...
                    slot.classList.add("selected-slot")
                    selectedTile = Number(slot.currentItemId)
                })
                ...
                if (itemInfo.tileset != "" && itemInfo.tileset != undefined && images[`assets/Tilesets/${itemInfo.tileset}.png`]) {
                    ...
                    //bruh
                    itemImage.style = `background-image: url(assets/Tilesets/${itemInfo.tileset}.png); background-position: -${backgroundPosX}px -${backgroundPosY}px; background-size: ${backgroundSizeX}px ${backgroundSizeY}px;`
